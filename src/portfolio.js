  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Creating application backend in Node, Express & loopback",
        "⚡ Integration of third party services such as sanity.io / AWS / Firebase",
      ],
      softwareSkills: [
        {
          skillName: "HTML5",
  ...
  degrees: [
    {
      ...
      descriptions: [
        " 7.23 CGPA",
        "⚡ I have studied subjects like OOPS, Data Structures, Operating systems, Computer Networking, etc.",
...
const experience = {
  ...
  description:
    ...
    "⚡ Building responsive website front end using ReactJS" +
    "⚡ Data transformation using node and python scripts" +
    "⚡ Creating application backend in Node, Express & loopback" +
    "⚡ Integration of third party services such as sanity.io / AWS / Firebase",
